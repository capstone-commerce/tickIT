/*Users Table*/
insert into Users values('Daniel_A', 'password1', 'dadognra@kent.edu', '000-000-0000', 'Comp. Sci');
insert into Users values('Ryan_D', 'password2', 'rdarby4@kent.edu', '111-111-1111', 'Comp. Sci');
insert into Users values('Ian_W', 'password3', 'iwhitese@kent.edu', '222-222-2222', 'Comp. Sci');
insert into Users values('Yashashvi_R', 'password4', 'yrawat@kent.edu', '333-333-3333', 'Comp. Sci');
insert into Users values('Declan_B', 'password5', 'dbialowa@knt.edu', '444-444-4444', 'Comp. Sci');
insert into Users values('Shemon_R', 'password6', 'srawat1@kent.edu', '555-555-5555', 'Comp. Sci');
...
/*Archived Table*/
insert into Archived values('222222', 'James Neutron', 'Brainblast@yahoo.com', 'Not connecting to Internet', 10, 're-adding to domain', 'Ryan_D', 'Closed', '2019-03-16', 'HP', '888UHYSGY4', '111110');
